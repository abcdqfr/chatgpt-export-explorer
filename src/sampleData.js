...
const additionalConv1Messages = [
  {
    ...
    message: {
      ...
      content: {
        content_type: 'text',
        parts: [
          "That's very helpful! Can you show me a simple example of variables and functions in JavaScript?"
        ]
      },
      status: 'finished_successfully',
      end_turn: null,
...
const moreConv1Messages = [
  {
    ...
    message: {
      ...
      content: {
        content_type: 'text',
        parts: [
          'This is great! I understand variables now. Can you explain how arrays work and show me some practical examples?'
        ]
      },
      status: 'finished_successfully',
      end_turn: null,
